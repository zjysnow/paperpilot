/**
 * paperpilotfor-zotero — Public Extension API
 * ======================================
 *
 * This module is the single entry point for third-party Zotero plugin authors
 * who want to register custom tools with the paperpilotfor-zotero agent.
 *
 * ## Quick start
 *
 ...
 *      "path/to/paperpilotfor-zotero/src/agent/extensionApi";
 *    import { ok, fail } from
 *      "path/to/paperpilotfor-zotero/src/agent/extensionApi";
 *    ```
 *
