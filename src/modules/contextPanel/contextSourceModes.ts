...
> = {
  pdf: {
    ...
    cssClassName: "paperpilotpaper-context-chip-pdf",
  ...
  text: {
    ...
    cssClassName: "paperpilotpaper-context-chip-text",
  ...
  mineru: {
    ...
    cssClassName: "paperpilotpaper-context-chip-mineru",
  ...
  html: {
    ...
    cssClassName: "paperpilotpaper-context-chip-html",
